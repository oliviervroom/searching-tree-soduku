...
class Solver:
    ...
    def fill_zero_values(self, values):
        for cube_n in range(1,10):
            ...
            values[self.get_row_start(cube_n):self.get_row_end(cube_n), self.get_col_start(cube_n):self.get_col_end(cube_n)] = [flat_list[i:i + 3] for i in range(0, len(flat_list), 3)]
